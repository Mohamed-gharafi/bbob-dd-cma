...
### prepare
suite = cocoex.Suite(suite_name, "year: 2021", suite_filter_options)
        ...
        if 11 < 3:  # add solver to investigate here
            ...
            xopt, es = fmin(
                    problem, propose_x0, sigma,
                    {
                        ...
                        'popsize' : popsize,
                        'termination_callback' : lambda _ : problem.final_target_hit,
                        'CMA_diagonal_decoding' : 1
                    },
                    restarts = 0
                    )
