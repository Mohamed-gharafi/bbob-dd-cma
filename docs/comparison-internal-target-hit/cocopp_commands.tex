...
\providecommand{\algDtables}{\StrLeft{ddcma-tt}{\ntables}}
\providecommand{\algCtables}{\StrLeft{ddcma-t0}{\ntables}}
...
\providecommand{\algsfolder}{cma-t_cma-t_ddcma_ddcma_CMA-E/}
\providecommand{\algorithmA}{CMA-ES-2019 Hansen}
\providecommand{\algorithmB}{cma-t0}
\providecommand{\algorithmC}{cma-t1}
\providecommand{\algorithmD}{ddcma-t0}
\providecommand{\algorithmE}{ddcma-tt}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\algBtables}{\StrLeft{ddcma-tt}{\ntables}}
\providecommand{\algAtables}{\StrLeft{ddcma-t1}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
