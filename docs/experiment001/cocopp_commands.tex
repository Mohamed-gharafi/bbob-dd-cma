...
\providecommand{\numofalgs}{1}
\providecommand{\algname}{fmin of ddcma 2D on bbob-006{}}
\providecommand{\algfolder}{fmin_of_ddcma_2D_on_bbob-006/}
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{fmin of ddcma 2D on bbob-005{}}
\providecommand{\algfolder}{fmin_of_ddcma_2D_on_bbob-005/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{fmin of ddcma 2D on bbob-004{}}
\providecommand{\algfolder}{fmin_of_ddcma_2D_on_bbob-004/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
